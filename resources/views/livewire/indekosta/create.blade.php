...
<div>
    <x-slot name="title">Tambah Indekosta</x-slot>

    <x-slot name="pagePretitle">Menambah indekosta.</x-slot>

    <x-slot name="pageTitle">Tambah Indekosta</x-slot>
