<div>
    ...
    <div class="row mb-3 align-items-center justify-content-between">
        <div class="col-12 col-lg-5 d-flex">
            <div>
                <x-datatable.search placeholder="Cari rekomendasi..." />
            </div>
        </div>
            ...
            <table class="table card-table table-bordered datatable">
                <thead>
                    <tr>
                        ...
                        <th>
                            <x-datatable.column-sort name="Rating" wire:click="sortBy('rating')" :direction="$sorts['rating'] ?? null" />
                        </th>

                        <th>
                            <x-datatable.column-sort name="Ulasan" wire:click="sortBy('ulasan')" :direction="$sorts['ulasan'] ?? null" />
                        </th>
                            ...
                            <td colspan="10" class="bg-azure-lt">
                                ...
                                @else
                                    <span class="text-pink">Anda sekarang memilih semua
                                        <strong>{{ count($this->selected) }}</strong> rekomendasi.
                                    </span>
                                @endif
                            </td>
                        </tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <span class="avatar avatar-sm"
                                        style="background-image: url({{ $row->akun->avatarUrl() }})"></span>
